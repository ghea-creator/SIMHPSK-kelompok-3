...
- **Backend**: Laravel 11
- **Frontend Web**: Bootstrap 5.3 + Blade Templating
- **Frontend Mobile**: Flutter (folder `mobile_app/`)
- **Database**: MySQL
- **Charts**: Chart.js
...
Agar jelas untuk penilaian dan dokumentasi GitHub:

- `mobile_app/` adalah **frontend mobile** menggunakan Flutter.
- `app/`, `routes/`, `config/`, `resources/views/`, dan file Laravel lainnya adalah **backend**.
- Backend melayani API dan aplikasi web admin.
- Frontend mobile dapat berjalan terpisah dengan `flutter run` dan menggunakan backend API.
