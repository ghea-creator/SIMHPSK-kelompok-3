...
class SuperAdminController extends Controller
{
    ...
    public function getLandingApi()
    {
        ...
        // Pastikan selalu return object {} bukan array [] saat kosong
        $data = $contents->isEmpty() ? (object)[] : $contents;
        return $this->successResponse($data, 'Konten landing page berhasil diambil.');
    }
